            ...
            <div class="col-12">
                <div class="card">
                    <div class="card-body">
                        ...
                        <form id="myForm" method="post" action="{{ route('post.update') }}"
                            ...
                            <div class="row">
                                <div class="form-group col-md-6 mb-3">
                                    ...
                                    <select name="category_id" class="form-select" id="example-select">
                                        ...
                                        <option value="{{ $category->id }}" {{ $category->id == $newspost->category_id ?
                                ...
                                <div class="form-group col-md-6 mb-3">
                                    ...
                                    <select name="subcategory_id" class="form-select" id="example-select">
                                        ...
                                        <option value="{{ $subcategory->id }}" {{ $subcategory->id ==
                                            $newspost->subcategory_id ? 'selected' : '' }} >{{
                                    ...
                                    <div class="col-lg-6">
                                        <div class="form-check mb-2 form-check-primary">
                                            <input class="form-check-input" type="checkbox" name="breaking_news"
                                                value="1" id="customckeck1" {{ $newspost->breaking_news == 1 ? 'checked'
                                            : '' }} >
                                        ...
                                        <div class="form-check mb-2 form-check-primary">
                                            <input class="form-check-input" type="checkbox" name="top_slider" value="1"
                                                id="customckeck2" {{ $newspost->top_slider == 1 ? 'checked' : '' }} >
                                    ...
                                    <div class="col-lg-6">
                                        <div class="form-check mb-2 form-check-danger">
                                            <input class="form-check-input" name="first_section_three" type="checkbox"
                                                value="1" id="customckeck3" {{ $newspost->first_section_three == 1 ?
                                            'checked' : '' }} >
                                        ...
                                        <div class="form-check mb-2 form-check-danger">
                                            <input class="form-check-input" name="first_section_nine" type="checkbox"
                                                value="1" id="customckeck4" {{ $newspost->first_section_nine == 1 ?
                                            'checked' : '' }}>
