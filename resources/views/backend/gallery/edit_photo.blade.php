...
<div class="content">
    ...
    <form id="myForm" method="post" action="{{ route('update.image.gallery') }}" enctype="multipart/form-data">
    	@csrf 
  ...
  <input type="file" name="multi_image" class="form-control" id="image" > 
         ...
         <img src="{{ asset($image->photo_gallery)  }}" style="width:400px; height: 200px;">
