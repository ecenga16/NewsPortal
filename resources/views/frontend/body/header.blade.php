                ...
                <div class="row mb-1 justify-content-between">
                        ...
                        <div class="prayerTimesExample">
                            ...
                            <div class="row">
                                ...
                                <div class="col-6 md-col-4">
                                    <button class="btn btn-success" type="button" onclick="fetchPrayerTimes()">Get
                                        Prayer Times</button>
                                    </form>
                                </div>
                            ...
                            <div class="date ml-md-2">
                                <div class="row todayPrayersContainer">
                                    <div class="large-2 medium-2 small-2 columns todayPrayer" id="box">
                                        <div class="todayPrayerNameContainer"><span
                                                class="todayPrayerName">Imsaku</span></div>
                                        <div class="todayPrayerDetailContainer"><span class="todayPrayerTime"
                                                id="fajr"></span></div>
                                    </div>
                                    <div class="large-2 medium-2 small-2 columns todayPrayer" id="box">
                                        <div class="todayPrayerNameContainer"><span class="todayPrayerName">L.
                                                Diellit</span></div>
                                        <div class="todayPrayerDetailContainer"><span class="todayPrayerTime"
                                                id="shurooq"></span></div>
                                    </div>
                                    <div class="large-2 medium-2 small-2 columns todayPrayer" id="box">
                                        <div class="todayPrayerNameContainer"><span class="todayPrayerName">Yleja</span>
                                        </div>
                                        <div class="todayPrayerDetailContainer"><span class="todayPrayerTime"
                                                id="dhuhr"></span></div>
                                    </div>
                                    <div class="large-2 medium-2 small-2 columns todayPrayer" id="box">
                                        <div class="todayPrayerNameContainer"><span
                                                class="todayPrayerName">Ikindia</span></div>
                                        <div class="todayPrayerDetailContainer"><span class="todayPrayerTime"
                                                id="asr"></span></div>
                                    </div>
                                    <div class="large-2 medium-2 small-2 columns todayPrayer" id="box">
                                        <div class="todayPrayerNameContainer"><span
                                                class="todayPrayerName">Akshami</span></div>
                                        <div class="todayPrayerDetailContainer"><span class="todayPrayerTime"
                                                id="maghrib"></span></div>
                                    </div>
                                    <div class="large-2 medium-2 small-2 columns todayPrayer" id="box">
                                        <div class="todayPrayerNameContainer"><span class="todayPrayerName">Jacia</span>
                                        </div>
                                        <div class="todayPrayerDetailContainer"><span class="todayPrayerTime"
                                                id="isha"></span></div>
                                    </div>
                    ...
                    <div class="col-md-4 align-bottom-custom mb-3">
                        <a href="{{ route('donate.page') }}"
                            class="donate-button animated mt-3 mt-md-5 mr-md-5 mx-auto">Donate Now</a>
                    </div>
                </div>
            </div>
        </div>
            ...
            <div class="col-lg-12 col-md-12">
                <div class="mobileLogo">
                    <a href=" " title="NewsFlash">
                        <img src="{{ asset('frontend/assets/images/logo.jpg') }}" alt="Logo" title="Logo"
                ...
                <div class="stellarnav dark desktop"><a href="https://newssitedesign.com/newsflash/#"
                    ...
                    <ul id="menu-main-menu" class="menu">
                        <li id="menu-item-89"
                            ...
                            <a href="{{route('homepage')}}" aria-current="page"> <i class="fa-solid fa-house-user"></i>
                                HOME</a>
                        </li>
                        ...
                        <li id="menu-item-291"
                            class="menu-item menu-item-type-taxonomy menu-item-object-category menu-item-291">
