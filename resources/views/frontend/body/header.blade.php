...
<li id="menu-item-291" class="menu-item menu-item-type-taxonomy menu-item-object-category menu-item-291"><a href=" ">{{ $category->category_name }}</a>
...
@endphp    
    ...
    @foreach($subcategories as $subcategory)
        <li id="menu-item-294" class="menu-item menu-item-type-taxonomy menu-item-object-category menu-item-294"><a href=" ">{{$subcategory->subcategory_name}}</a>
        </li>
    @endforeach
    </ul>
