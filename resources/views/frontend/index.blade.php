            ...
            <div class="col-lg-9 col-md-8">
                <div class="row">
                    <div class="col-lg-7 col-md-7">
                        <div class="themesbazar_led_active owl-carousel owl-loaded owl-drag">
                            ...
                            @php
                            $news_slider = App\Models\Posts::where('status',1)->where('top_slider',1)->orderBy('id',
                            'DESC')->limit(5)->get();
                            @endphp
                            @php
                                            ...
                                            <div class="sec-one-image">
                                                <a
                                                    href="{{ url('news/details/'.$slider->id.'/'.$slider->news_title_slug) }}"><img
                                                        class="lazyload" src="{{ asset($slider->news_image) }}"></a>
                    ...
                    <div class="col-lg-5 col-md-5">
                        ...
                        @php
                        $section_three =
                        App\Models\Posts::where('status',1)->where('first_section_three',1)->orderBy('id',
                        'DESC')->limit(3)->get();
                        @endphp
                        ...
                        <div class="secOne-smallItem">
                            <div class="secOne-smallImg">
                                <a href="{{url('news/details/'.$three['id'].'/'.$three['news_title_slug'])}}  "><img
                                        class="lazyload" src="{{ asset($three->news_image) }}"></a>
                ...
                <div class="sec-one-item2">
                    <div class="row">
                        ...
                        @php
                        $section_nine =
                        App\Models\Posts::where('status',1)->where('first_section_nine',1)->orderBy('id',
                        'DESC')->limit(9)->get();
                        @endphp
                                ...
                                <div class="secOne-news">
                                    <div class="secOne-image2">
                                        <a href="{{ url('news/details/'.$nine->id.'/'.$nine->news_title_slug) }} "><img
                                                class="lazyload" src="{{ asset($nine->news_image) }}"></a>
                                    </div>
                ...
                <div class="live-item">
                    ...
                    <div class="popup-wrpp">
                        <div class="live_image">
                            <img width="700" height="400" src="{{ asset(isset($live->live_image)) }}"
                            ...
                            <div id="mymodal" class="mfp-hide" role="dialog" aria-labelledby="modal-titles"
                                ...
                                <div id="modal-contents">
                                    <div class="embed-responsive embed-responsive-16by9 embed-responsive-item">
                                        <iframe width="560" height="315" src="{{ isset($live->live_url) }}"
                        ...
                        <div class="news-titletab">
                            ...
                            <div class="tab-image tab-border">
                                <a href="{{ url('news/details/'.$item->id.'/'.$item->news_title_slug) }}"><img
                                        class="lazyload" src="{{ asset($item->news_image) }}"></a>
            ...
            <div class="themesBazar_widget">
                <div class="textwidget">
                    <p><img loading="lazy" class="aligncenter size-full wp-image-74"
                            src="{{ asset(isset($banner->home_one)) }}" alt="" width="100%" height="auto"></p>
                </div>
            </div>
        </div>
        <div class="col-lg-6 col-md-6">
            <div class="themesBazar_widget">
                <div class="textwidget">
                    <p><img loading="lazy" class="aligncenter size-full wp-image-74"
                            src="{{ asset(isset($banner->home_two)) }}" alt="" width="100%" height="auto"></p>
                </div>
            </div>
        </div>
    </div>
                        ...
                        <ul class="nav nav-pills" id="categori-tab" role="tablist">
                            ...
                            <li class="nav-item" role="presentation">
                                <div class="nav-link" id="categori-tab2" data-bs-toggle="pill"
                                    data-bs-target="#category{{$category['id']}}" role="tab" aria-controls="Info-tabs2"
                                    aria-selected="false">
                    ...
                    <div class="tab-content" id="pills-tabContent">
                        ...
                        <div class="tab-pane fade" id="category{{$category['id']}}" role="tabpanel"
                            ...
                            <div class="row">
                                ...
                                $catwisenews = App\Models\Posts::where('category_id', $category['id'])->orderBy('id',
                                'DESC')->limit(8)->get();
                                ...
                                <div class="themesBazar-4 themesBazar-m2">
                                    <div class="sec-two-wrpp">
                                        <div class="section-two-image">
                                            <<a
                                                href="{{url('news/details/'.$item['id'].'/'.$item['news_title_slug'])}}  ">
                                                <img class="lazyload" src="{{asset($item['news_image'])}}"></a>
                                        </div>
                                        <h5 class="sec-two-title">
                                            <a
                                                href="{{url('news/details/'.$item['id'].'/'.$item['news_title_slug'])}}  ">{{$item['news_title']}}</a>
    ...
    <div class="row">
        <div class="col-lg-6 col-md-6">
            <div class="themesBazar_widget">
                <div class="textwidget">
                    <p><img loading="lazy" class="aligncenter size-full wp-image-74"
                            src="{{ asset(isset($banner->home_three)) }}" alt="" width="100%" height="auto"></p>
                </div>
            </div>
        </div>
        <div class="col-lg-6 col-md-6">
            <div class="themesBazar_widget">
                <div class="textwidget">
                    <p><img loading="lazy" class="aligncenter size-full wp-image-74"
                            src="{{ asset(isset($banner->home_four)) }}" alt="" width="100%" height="auto"></p>
                </div>
            </div>
        </div>
    </div>
    ...
    <div class="container">
        <div class="row">
            <div class="col-lg-4 col-md-4">
                ...
                <h2 class="themesBazar_cat01"> <a href=" ">{{$skip_cat_0['category_name']}}</a> <span> <a href=" "> More
                ...
                <div class="white-bg">
                    ...
                    <div class="secFive-smallItem">
                        <div class="secFive-smallImg">
                            <a href="{{ url('news/details/'.$item->id.'/'.$item->news_title_slug) }}"><img
                                    class="lazyload" src="{{$item->news_image}}"></a>
                            <h5 class="secFive_title2">
                                <a
                                    href="{{ url('news/details/'.$item->id.'/'.$item->news_title_slug) }} ">{{$item->news_title}}</a>
                            </h5>
            ...
            <div class="col-lg-4 col-md-4">
                ...
                <h2 class="themesBazar_cat01"> <a href=" "> {{$skip_cat_1['category_name']}} </a> <span> <a
            ...
            <div class="col-lg-4 col-md-4">
                ...
                <h2 class="themesBazar_cat01"> <a href=" "> {{$skip_cat_2['category_name']}} </a> <span> <a href=" ">
    ...
    <div class="container">
        <div class="row">
            <div class="col-lg-4 col-md-4">
                ...
                <h2 class="themesBazar_cat01"> <a href=" ">{{$skip_cat_4['category_name']}}</a> <span> <a href=" "> More
                            <i class="las la-arrow-circle-right"></i> </a></span> </h2>
            ...
            <div class="col-lg-4 col-md-4">
                ...
                <h2 class="themesBazar_cat01"> <a href=" "> {{$skip_cat_5['category_name']}} </a> <span> <a
                            href=" ">More <i class="las la-arrow-circle-right"></i> </a></span> </h2>
            ...
            <div class="col-lg-4 col-md-4">
                ...
                <h2 class="themesBazar_cat01"> <a href=" "> {{$skip_cat_6['category_name']}} </a> <span> <a href=" ">
                            More <i class="las la-arrow-circle-right"></i> </a></span> </h2>
