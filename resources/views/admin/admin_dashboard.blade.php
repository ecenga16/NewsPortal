...
<head>
    ...
    <script src="https://cdn.tiny.cloud/1/6sktdnttfqdr3jswqowyet7bf7o7x2y0x6nxstev66so4b63/tinymce/6/tinymce.min.js"
...
<body
    ...
    <script src="{{ asset('backend/assets/js/check-removal.js') }}"></script>
    <script>
